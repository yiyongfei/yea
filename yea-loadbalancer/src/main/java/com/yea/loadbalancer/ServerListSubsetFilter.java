 ...
 * @param <T>
 */
public class ServerListSubsetFilter<T extends BalancingNode> extends ZoneAffinityServerListFilter<T> implements IClientConfigAware, Comparator<T>{
    ...
    public Collection<T> getFilteredListOfNodes(Collection<T> servers) {
    	Collection<T> zoneAffinityFiltered = super.getFilteredListOfNodes(servers);
