...
import com.yea.loadbalancer.ConfigurationBasedNodeList;
import com.yea.loadbalancer.DummyPing;
import com.yea.loadbalancer.IVipAddressResolver;
import com.yea.loadbalancer.PollingServerListUpdater;
import com.yea.loadbalancer.SimpleVipAddressResolver;
import com.yea.loadbalancer.ZoneAwareLoadBalancer;
...
public class DefaultClientConfigImpl implements IClientConfig {
	...
	public static final String DEFAULT_NFLOADBALANCER_PING_CLASSNAME = DummyPing.class.getName(); // DummyPing.class.getName();

    public static final String DEFAULT_NFLOADBALANCER_RULE_CLASSNAME = AvailabilityFilteringRule.class.getName();

    public static final String DEFAULT_NFLOADBALANCER_CLASSNAME = ZoneAwareLoadBalancer.class.getName();
    
    public static final boolean DEFAULT_USEIPADDRESS_FOR_SERVER = Boolean.FALSE;

    public static final String DEFAULT_VIPADDRESS_RESOLVER_CLASSNAME = SimpleVipAddressResolver.class.getName();
    ...
    public static final String DEFAULT_SEVER_LIST_CLASS = ConfigurationBasedNodeList.class.getName();

    public static final String DEFAULT_SERVER_LIST_UPDATER_CLASS = PollingServerListUpdater.class.getName();
    ...
    private IVipAddressResolver resolver = null;
	...
	public IVipAddressResolver getResolver() {
		return resolver;
	}
    ...
    public <T> DefaultClientConfigImpl setClientName(String clientName){
    ...
    private IVipAddressResolver getVipAddressResolver() {
        if (resolver == null) {
            synchronized (this) {
                if (resolver == null) {
                    try {
                        resolver = (IVipAddressResolver) Class
