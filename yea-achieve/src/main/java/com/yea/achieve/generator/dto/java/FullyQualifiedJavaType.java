...
public class FullyQualifiedJavaType implements
    ...
    private void parse(String fullTypeSpecification) {
        ...
        if (spec.startsWith("?")) { //$NON-NLS-1$
            ...
            if (index == -1) {
                ...
                if (endIndex == -1) {
                    throw new RuntimeException("Invalid Type Specification: " + fullTypeSpecification); //$NON-NLS-1$
                }
    ...
    private void genericParse(String genericSpecification) {
        ...
        if (lastIndex == -1) {
            ...
            throw new RuntimeException("Invalid Type Specification: " + genericSpecification); //$NON-NLS-1$
        }
