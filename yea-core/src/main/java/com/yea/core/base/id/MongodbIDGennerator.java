 ...
 */
public final class MongodbIDGennerator implements Comparable<MongodbIDGennerator>, Serializable {
     ...
     * @return the new id
     */
    public static MongodbIDGennerator get() {
        return new MongodbIDGennerator();
    }
     ...
     * @since 2.12.0
     */
    public static MongodbIDGennerator createFromLegacyFormat(final int time, final int machine, final int inc) {
        return new MongodbIDGennerator(time, machine, inc);
    }

    /**
     * Create a new object id.
     */
    public MongodbIDGennerator() {
        this(new Date());
    }
     ...
     * @param date the date
     */
    public MongodbIDGennerator(final Date date) {
     ...
     */
    public MongodbIDGennerator(final Date date, final int counter) {
     ...
     */
    public MongodbIDGennerator(final Date date, final int machineIdentifier, final short processIdentifier, final int counter) {
     ...
     * @throws IllegalArgumentException if the high order byte of machineIdentifier or counter is not zero
     */
    public MongodbIDGennerator(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter) {
        this(timestamp, machineIdentifier, processIdentifier, counter, true);
    }

    private MongodbIDGennerator(final int timestamp, final int machineIdentifier, final short processIdentifier, final int counter,
     ...
     */
    public MongodbIDGennerator(final String hexString) {
     ...
     */
    public MongodbIDGennerator(final byte[] bytes) {
        if (bytes == null) {
            throw new IllegalArgumentException();
        }
        if (bytes.length != 12) {
     ...
     */
    MongodbIDGennerator(final int timestamp, final int machineAndProcessIdentifier, final int counter) {
    ...
    public boolean equals(final Object o) {
        ...
        MongodbIDGennerator objectId = (MongodbIDGennerator) o;
    ...
    public int compareTo(final MongodbIDGennerator other) {
        if (other == null) {
    ...
    /**
     * @return a string representation of the ObjectId in hexadecimal format
     * @see MongodbIDGennerator#toHexString()
