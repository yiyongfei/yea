 ...
 *
 */
public class TriggerORMHandle<T> extends AbstractORMHandle<T> {
    
	public TriggerORMHandle() {
		super(ORMConstants.ORM_LEVEL.M_TRIGGER.getCode());
	}
	...
	public void setNextHandle() {
		...
		ORMHandle<T> nextHandle = ORMHandleFactory.getInstance(ORMConstants.ORM_LEVEL.M_INSERT);
