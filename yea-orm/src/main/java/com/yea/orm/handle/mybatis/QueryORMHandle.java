 ...
 *
 */
public class QueryORMHandle<T> extends AbstractORMHandle<T> {
    
	public QueryORMHandle() {
		super(ORMConstants.ORM_LEVEL.M_QUERY.getCode());
	}
	...
	protected T execute(SqlSessionTemplate sessionTemplate, ORMParams dto) {
		...
		if(dto.getParam() == null){
			return sessionTemplate.selectOne(dto.getSqlid());
		}
	...
	public void setNextHandle() {
		// TODO Auto-generated method stub
		ORMHandle<T> nextHandle = ORMHandleFactory.getInstance(ORMConstants.ORM_LEVEL.M_QUERYLIST);
