...
public class SaveORMHandle<T> extends AbstractORMHandle<T> {
    
	public SaveORMHandle() {
		super(ORMConstants.ORM_LEVEL.M_INSERT.getCode());
	}
	...
	protected T execute(SqlSessionTemplate sessionTemplate, ORMParams dto) throws Exception {
		return (T) Integer.valueOf(sessionTemplate.insert(dto.getSqlid(), dto.getParam()));
	}

	@Override
	public void setNextHandle() {
		// TODO Auto-generated method stub
		ORMHandle<T> nextHandle = ORMHandleFactory.getInstance(ORMConstants.ORM_LEVEL.M_DELETE);
